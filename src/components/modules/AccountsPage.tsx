  ...
  return (
    <div className="p-8 space-y-6 overflow-auto h-full bg-gradient-to-br from-gray-50 to-gray-100">
      <header className="flex justify-between items-center">
        ...
        <button onClick={() => { setShowForm(true); setForm({ description: '', amount: 0, due_date: '', category: 'Geral', notes: '', ref_id: '' }); }} className="bg-amber-600 text-white px-6 py-3 rounded-2xl font-bold hover:bg-amber-700 flex items-center gap-2 shadow-lg">
