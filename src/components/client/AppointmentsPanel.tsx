...
import { Calendar, Clock, Plus, CheckCircle, AlertCircle, Loader2, Wrench, Users, Shield, X } from 'lucide-react';
              ...
              <div className="grid gap-2">
                {APPOINTMENT_TYPES.map((t) => (
                  <button
                    ...
                    className={`flex items-center gap-3 p-3 rounded-xl border transition-all text-left touch-manipulation ${
                      type === t.value
