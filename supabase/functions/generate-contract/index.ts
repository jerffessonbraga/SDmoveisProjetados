...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Você é um assistente especializado em gerar contratos e ordens de serviço para a SD Móveis, uma empresa de móveis planejados em Fortaleza-CE.
